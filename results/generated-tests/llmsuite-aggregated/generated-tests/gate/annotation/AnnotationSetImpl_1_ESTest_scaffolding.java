...
public class AnnotationSetImpl_1_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AnnotationSetImpl_1_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.corpora.DocumentImpl", false, AnnotationSetImpl_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("gate.event.GateListener", false, AnnotationSetImpl_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, AnnotationSetImpl_1_ESTest_scaffolding.class.getClassLoader()));
  }
}
