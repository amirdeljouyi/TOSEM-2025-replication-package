...
public class DocumentStaxUtils_5_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.Annotation", false, DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("gate.Node", false, DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.xml.stream.StreamFilter", false, DocumentStaxUtils_5_ESTest_scaffolding.class.getClassLoader()));
  }
}
