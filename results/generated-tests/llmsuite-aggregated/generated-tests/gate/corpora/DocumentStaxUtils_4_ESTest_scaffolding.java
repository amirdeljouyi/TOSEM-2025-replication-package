...
public class DocumentStaxUtils_4_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.Annotation", false, DocumentStaxUtils_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("gate.Node", false, DocumentStaxUtils_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.xml.stream.StreamFilter", false, DocumentStaxUtils_4_ESTest_scaffolding.class.getClassLoader()));
  }
}
