...
public class DocumentStaxUtils_1_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.Annotation", false, DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("gate.Node", false, DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader()));
