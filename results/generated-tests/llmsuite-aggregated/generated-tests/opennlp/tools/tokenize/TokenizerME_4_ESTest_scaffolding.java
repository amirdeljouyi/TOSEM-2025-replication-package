...
public class TokenizerME_4_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("opennlp.tools.ml.model.MaxentModel", false, TokenizerME_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenContextGenerator", false, TokenizerME_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenizerFactory", false, TokenizerME_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenizerModel", false, TokenizerME_4_ESTest_scaffolding.class.getClassLoader()));
  }
}
