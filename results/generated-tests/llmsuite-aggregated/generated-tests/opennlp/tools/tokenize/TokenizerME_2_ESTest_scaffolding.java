...
public class TokenizerME_2_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TokenizerME_2_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("opennlp.tools.ml.model.MaxentModel", false, TokenizerME_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenContextGenerator", false, TokenizerME_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenizerFactory", false, TokenizerME_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.tokenize.TokenizerModel", false, TokenizerME_2_ESTest_scaffolding.class.getClassLoader()));
  }
}
