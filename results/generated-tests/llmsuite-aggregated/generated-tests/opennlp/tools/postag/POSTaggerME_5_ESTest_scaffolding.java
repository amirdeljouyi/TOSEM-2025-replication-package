...
public class POSTaggerME_5_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("opennlp.tools.ml.model.SequenceClassificationModel", false, POSTaggerME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.postag.POSContextGenerator", false, POSTaggerME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.postag.POSTaggerFactory", false, POSTaggerME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.postag.TagDictionary", false, POSTaggerME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.SequenceValidator", false, POSTaggerME_5_ESTest_scaffolding.class.getClassLoader()));
  }
}
