...
public class POSTaggerFactory_3_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(POSTaggerFactory_3_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, POSTaggerFactory_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.postag.POSSample", false, POSTaggerFactory_3_ESTest_scaffolding.class.getClassLoader()));
  }
}
