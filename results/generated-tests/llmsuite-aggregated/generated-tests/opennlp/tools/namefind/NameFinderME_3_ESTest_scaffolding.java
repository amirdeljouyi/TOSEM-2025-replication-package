...
public class NameFinderME_3_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NameFinderME_3_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("opennlp.tools.ml.model.SequenceClassificationModel", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.NameContextGenerator", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.TokenNameFinderFactory", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.TokenNameFinderModel", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.Sequence", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.SequenceCodec", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.SequenceValidator", false, NameFinderME_3_ESTest_scaffolding.class.getClassLoader()));
  }
}
