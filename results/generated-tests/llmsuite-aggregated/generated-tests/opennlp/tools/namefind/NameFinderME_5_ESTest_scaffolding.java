...
public class NameFinderME_5_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NameFinderME_5_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("opennlp.tools.ml.model.SequenceClassificationModel", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.NameContextGenerator", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.TokenNameFinderFactory", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.namefind.TokenNameFinderModel", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.Sequence", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.SequenceCodec", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("opennlp.tools.util.SequenceValidator", false, NameFinderME_5_ESTest_scaffolding.class.getClassLoader()));
  }
}
