...
public class Mention_3_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.stanford.nlp.semgraph.SemanticGraph", false, Mention_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.trees.TypedDependency", false, Mention_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, Mention_3_ESTest_scaffolding.class.getClassLoader()));
  }
}
