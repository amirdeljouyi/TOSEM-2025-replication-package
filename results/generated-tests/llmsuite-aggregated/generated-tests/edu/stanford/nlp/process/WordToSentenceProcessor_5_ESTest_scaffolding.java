...
public class WordToSentenceProcessor_5_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WordToSentenceProcessor_5_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.stanford.nlp.ling.tokensregex.SequencePattern$Parser", false, WordToSentenceProcessor_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.util.Pair", false, WordToSentenceProcessor_5_ESTest_scaffolding.class.getClassLoader()));
  }
}
