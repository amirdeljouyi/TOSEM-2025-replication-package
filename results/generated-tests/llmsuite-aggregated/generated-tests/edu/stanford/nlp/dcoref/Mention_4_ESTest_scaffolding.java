...
public class Mention_4_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Mention_4_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.stanford.nlp.classify.LogisticClassifier", false, Mention_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.dcoref.Dictionaries", false, Mention_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.dcoref.MentionExtractor", false, Mention_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.dcoref.Semantics", false, Mention_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.semgraph.SemanticGraph", false, Mention_4_ESTest_scaffolding.class.getClassLoader()));
  }
}
