...
public class ArabicSegmenterAnnotator_2_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "edu.stanford.nlp.pipeline.ArabicSegmenterAnnotator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ArabicSegmenterAnnotator_2_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.stanford.nlp.international.arabic.process.ArabicSegmenter", false, ArabicSegmenterAnnotator_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, ArabicSegmenterAnnotator_2_ESTest_scaffolding.class.getClassLoader()));
  }
}
