...
public class LexicalizedParser_2_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.stanford.nlp.parser.lexparser.BinaryGrammar", false, LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.parser.lexparser.Lexicon", false, LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("edu.stanford.nlp.parser.lexparser.UnaryGrammar", false, LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, LexicalizedParser_2_ESTest_scaffolding.class.getClassLoader()));
  }
}
