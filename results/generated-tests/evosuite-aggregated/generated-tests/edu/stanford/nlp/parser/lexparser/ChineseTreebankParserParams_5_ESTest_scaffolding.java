...
public class ChineseTreebankParserParams_5_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChineseTreebankParserParams_5_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, ChineseTreebankParserParams_5_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, ChineseTreebankParserParams_5_ESTest_scaffolding.class.getClassLoader()));
  }
}
