...
public class ParallelTopicModel_1_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ParallelTopicModel_1_ESTest_scaffolding.class.getClassLoader() ,
      "bsh.Capabilities",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("cc.mallet.pipe.SerialPipes$Predicate", false, ParallelTopicModel_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Comparator", false, ParallelTopicModel_1_ESTest_scaffolding.class.getClassLoader()));
  }
}
