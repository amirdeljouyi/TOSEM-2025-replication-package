...
public class DocumentImpl_4_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.Factory$DuplicationContext", false, DocumentImpl_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, DocumentImpl_4_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, DocumentImpl_4_ESTest_scaffolding.class.getClassLoader()));
  }
}
