...
public class DocumentStaxUtils_1_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.xml.stream.StreamFilter", false, DocumentStaxUtils_1_ESTest_scaffolding.class.getClassLoader()));
  }
}
