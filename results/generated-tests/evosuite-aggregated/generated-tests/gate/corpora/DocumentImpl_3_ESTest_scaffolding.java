...
public class DocumentImpl_3_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("gate.annotation.AnnotationImpl", false, DocumentImpl_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, DocumentImpl_3_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToLongFunction", false, DocumentImpl_3_ESTest_scaffolding.class.getClassLoader()));
  }
}
