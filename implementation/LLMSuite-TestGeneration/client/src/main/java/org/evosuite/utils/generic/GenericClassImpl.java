...
//        LoggingUtils.getEvoLogger().info("type: " + type + " " + type.getClass());

        if (isWildcardType()) {
//            LoggingUtils.getEvoLogger().debug("Is wildcard type.");
            return getGenericWildcardInstantiation(typeMap, recursionLevel);
        } else if (isArray() || type instanceof GenericArrayType) {
//            LoggingUtils.getEvoLogger().debug("Is Array");
            return getGenericArrayInstantiation(typeMap, recursionLevel);
        } else if (isTypeVariable()) {
//            LoggingUtils.getEvoLogger().debug("Is type variable ");
            return getGenericTypeVariableInstantiation(typeMap, recursionLevel);
        } else if (isParameterizedType()) {
//            LoggingUtils.getEvoLogger().debug("Is parameterized type");
...
//					if(!parameterTypeClass.isAssignableFrom(parameterInstance)) {
    ...
    public boolean isGenericArray() {
        System.out.println("rawClass: " + rawClass);
