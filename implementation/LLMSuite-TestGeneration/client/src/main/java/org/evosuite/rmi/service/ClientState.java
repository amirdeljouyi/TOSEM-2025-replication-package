...
public enum ClientState {
    ...
    SEARCH_BEFORE("LLM TestCase", "Carving JUnit tests", 4),
    LLM("LLM TestCase", "Carving JUnit tests", 5),
    SEARCH("Search", "Generating test cases", 6),
    INLINING("Inlining", "Inlining constants", 7),
    MINIMIZING_VALUES("Minimizing values", "Minimizing primitive values in the tests", 8),
    MINIMIZATION("Minimizing", "Minimizing size/length of test cases", 9),
