...
public class TestCodeVisitor extends TestVisitor {
     ...
     *                  object.
     */
    protected void visitPrimitiveFieldAssertion(PrimitiveFieldAssertion assertion) throws NullPointerException {
        VariableReference source = assertion.getSource();
        Object value = assertion.getValue();
     ...
     */
    @Override
    public void visitPrimitiveStatement(PrimitiveStatement<?> statement) throws NullPointerException {
     ...
     */
    @Override
    public void visitPrimitiveExpression(PrimitiveExpression statement) throws NullPointerException {
        VariableReference retval = statement.getReturnValue();
     ...
     */
    @Override
    public void visitFieldStatement(FieldStatement statement) throws NullPointerException {
    ...
    private String getParameterString(Type[] parameterTypes,
        ...
        for (int i = startPos; i < parameters.size(); i++) {
            ...
            System.out.println(declaredParamType.getClass());
            System.out.println(declaredParamType.getTypeName());
            System.out.println(actualParamType);
            System.out.println(name);

            Class<?> rawParamClass;
            if(declaredParamType instanceof WildcardType){
                rawParamClass = Object.class;
            }
            else if(declaredParamType instanceof GenericArrayType){
                GenericArrayType aType = (GenericArrayType) declaredParamType;

                if(aType.getGenericComponentType() instanceof WildcardType) {
                    rawParamClass = Array.newInstance(Object.class, 0).getClass();
                } else {
                    rawParamClass = GenericTypeReflector.erase(declaredParamType);
                }
            }
            else {
                rawParamClass = GenericTypeReflector.erase(declaredParamType);
...
//            Class<?> rawParamClass = declaredParamType instanceof WildcardType ? Object.class : GenericTypeReflector.erase(declaredParamType);
            if (rawParamClass.isPrimitive() && name.equals("null")) {
                ...
                if (declaredParamType instanceof ParameterizedType) {
                    ParameterizedType declaredParameterizedType = (ParameterizedType) declaredParamType;
                    Type[] argTypes = declaredParameterizedType.getActualTypeArguments();
...
//                    System.out.println("ownertype: " + declaredParameterizedType.getOwnerType() + " " + declaredParameterizedType.getRawType() + " " + Arrays.toString(argTypes));
                }

//                System.out.println("declaredParamType: " + declaredParamType);
//                System.out.println("declaredParamTyp1: " + declaredParamType.getClass());
//                System.out.println("actualParamType: " + actualParamType);
                if (shouldCast && !GenericClassUtils.isAssignable(declaredParamType, actualParamType)) {
                    System.out.println("Castable: " + declaredParamType + " " + actualParamType);
                    System.out.println("isAssignable: " + GenericClassUtils.isAssignable(declaredParamType, actualParamType));
                ...
                System.out.println("d: " + declaredParamType);
                System.out.println("a: " + actualParamType);
                if (TypeUtils.isArrayType(declaredParamType)
                    ...
                    } else { //if (!GenericClassUtils.isAssignable(GenericTypeReflector.getArrayComponentType(declaredParamType), GenericTypeReflector.getArrayComponentType(actualParamType))) {
                        parameterString += "(" + getTypeName(declaredParamType) + ") ";
                    }
                } else if (!(declaredParamType instanceof WildcardType) && !(actualParamType instanceof ParameterizedType)) {
                    parameterString += "(" + getTypeName(declaredParamType) + ") ";
                }
                if (name.contains("(short"))
                    name = name.replace("(short)", "");
    ...
    @Override
    public void visitFunctionalMockStatement(FunctionalMockStatement st) throws NullPointerException {
...
//			result += parameter_string + " );"+NEWLINE;
     ...
     */
    @Override
    public void visitMethodStatement(MethodStatement statement) throws NullPointerException {
        String result = "";
        VariableReference retval = statement.getReturnValue();
     ...
     */
    @Override
    public void visitConstructorStatement(ConstructorStatement statement) throws NullPointerException {
        String result = "";
     ...
     */
    @Override
    public void visitArrayStatement(ArrayStatement statement) throws NullPointerException {
        VariableReference retval = statement.getReturnValue();
     ...
     */
    @Override
    public void visitAssignmentStatement(AssignmentStatement statement) throws NullPointerException {
        String cast = "";
        VariableReference retval = statement.getReturnValue();
...
//        }
     ...
     */
    @Override
    public void visitNullStatement(NullStatement statement) throws NullPointerException {
        VariableReference retval = statement.getReturnValue();
    ...
    @Override
    public void visitStatement(Statement statement) throws NullPointerException {
