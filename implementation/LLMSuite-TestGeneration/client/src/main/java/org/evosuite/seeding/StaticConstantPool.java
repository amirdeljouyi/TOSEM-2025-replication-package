...
import org.evosuite.llm.StaticPoolGeneration;
...
public class StaticConstantPool implements ConstantPool {
    ...
    public StaticConstantPool() {
        ...
        if(Properties.LLM_STATIC_CONSTANT_POOL) {
            StaticPoolGeneration sg = new StaticPoolGeneration();
            stringPool.addAll(sg.getLines());
        }
