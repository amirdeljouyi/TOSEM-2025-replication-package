...
public class TestCaseBuilder {
    ...
    public VariableReference appendConstructor(Constructor<?> constructor, GenericClass<?> genericClass, VariableReference... parameters) {
        List<VariableReference> parameter_list = Arrays.asList(parameters);
        ConstructorStatement constructorStmt = new ConstructorStatement(testCase,
                new GenericConstructor(constructor, genericClass), parameter_list);
    ...
    public VariableReference appendFunctionalMockMethod(GenericClass<?> genericClass) {
        VariableReference variableReference = new VariableReferenceImpl(testCase, genericClass);

        FunctionalMockStatement mockStmt = new FunctionalMockStatement(testCase, variableReference, genericClass);
        //        FunctionalMockStatement.canBeFunctionalMocked(type);
        addStatement(mockStmt);
        return mockStmt.getReturnValue();
    }
    ...
    public VariableReference appendAssignment(ArrayReference array, int index) {
        VariableReferenceImpl var = new VariableReferenceImpl(testCase, array.getComponentType());
    ...
    public void appendAssignment(VariableReference var1, VariableReference var2) {
        AssignmentStatement stmt = new AssignmentStatement(testCase, var1, var2);
        addStatement(stmt);
    }
