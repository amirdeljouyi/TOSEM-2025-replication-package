...
public class ResourceListTest {
    ...
    public void testHasClass() {
        ...
        Assert.assertTrue(ResourceList.getInstance(TestGenerationContext.getInstance().getClassLoaderForSUT()).hasClass(Foo.InternalFooClass.class.getName()));
    }

    @Test
    public void testHasCandidateAllPossibilities() {
        Assert.assertEquals("com.examples.with.different.packagename.classpath.Foo",
                ResourceList.getInstance(TestGenerationContext.getInstance().getClassLoaderForSUT()).hasCandidateAllPossibilities(Foo.class.getSimpleName()));
        Assert.assertEquals("com.examples.with.different.packagename.classpath.Foo$InternalFooClass",
                ResourceList.getInstance(TestGenerationContext.getInstance().getClassLoaderForSUT()).hasCandidateAllPossibilities(Foo.InternalFooClass.class.getSimpleName()));
