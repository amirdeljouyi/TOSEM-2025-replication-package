...
//        TestCase tc = new DefaultTestCase();
//        int[] indices = {2, 3};
//        List<Integer> currentIndices = Arrays.asList(1, 2);
//        ArrayStatement arrayStatement = new ArrayStatement(tc, int[][].class, indices);
//        tc.addStatement(arrayStatement);
//
//        IntPrimitiveStatement primitiveStmt = new IntPrimitiveStatement(tc, 1);
//        tc.addStatement(primitiveStmt);
//        VariableReference primitiveVar = primitiveStmt.getReturnValue();
//
//        ArrayIndex index = new ArrayIndex(tc, arrayStatement.getArrayReference(), currentIndices);
//
//        AssignmentStatement assignmentStatement = new AssignmentStatement(tc, index, primitiveVar);
//        tc.addStatement(assignmentStatement);
//
//        String code = tc.toCode();
//        System.out.println(tc);
